!function (c) {
  ...
  var e = function (h, g) {
    ...
    if (this.isRTL) {
      ...
      if (this.bootcssVer == 3) {
        this.picker.find(".prev span, .next span").toggleClass("fa-caret-left fa-caret-right")
      } else {
  ...
  e.prototype = {constructor: e, _events: [], _attachEvents: function () {
    ...
    var k, j, i;
    if (this.component) {
      k = this.component[this.offsetMethod]();
      i = k.left;
      if (this.pickerPosition == "bottom-left" || this.pickerPosition == "top-left") {
        i += this.component.outerWidth() - this.picker.outerWidth()
      }
    } else {
      k = this.element[this.offsetMethod]();
      i = k.left
    }
    ...
    if (this.pickerPosition == "bottom-left" || this.pickerPosition == "top-left") {
      var h = this.component ? this.component : this.element;
      i += h.outerWidth() - this.picker.outerWidth()
    }
  ...
  var b = {modes: [
    ...
    return g
  }, headTemplate: '<thead><tr><th class="prev"><i class="icon-arrow-left"/></th><th colspan="5" class="switch"></th><th class="next"><i class="icon-arrow-right"/></th></tr></thead>', headTemplateV3: '<thead><tr><th class="prev"><i class="fa fa-caret-left"></i> </th><th colspan="5" class="switch"></th><th class="next"><i class="fa fa-caret-right"></i> </th></tr></thead>', contTemplate: '<tbody><tr><td colspan="7"></td></tr></tbody>', footTemplate: '<tfoot><tr><th colspan="7" class="today"></th></tr></tfoot>'};
